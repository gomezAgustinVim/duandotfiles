...
return {
	...
	on_attach = function(_, buf)
		vim.api.nvim_buf_create_user_command(buf, "TexlabBuild", client_with_fn(buf_build), {
			desc = "Build the current buffer",
		})
		vim.api.nvim_buf_create_user_command(buf, "TexlabForward", client_with_fn(buf_search), {
			desc = "Forward search from current position",
		})
		vim.api.nvim_buf_create_user_command(buf, "TexlabCancelBuild", client_with_fn(buf_cancel_build), {
			desc = "Cancel the current build",
		})
		vim.api.nvim_buf_create_user_command(buf, "TexlabDependencyGraph", client_with_fn(dependency_graph), {
		...
		vim.api.nvim_buf_create_user_command(buf, "TexlabFindEnvironments", client_with_fn(buf_find_envs), {
			desc = "Find the environments at current position",
		})
		vim.api.nvim_buf_create_user_command(buf, "TexlabChangeEnvironment", client_with_fn(buf_change_env), {
